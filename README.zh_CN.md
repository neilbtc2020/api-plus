...
![api-plus](/web/public/logo-apiplus.svg)
...
<p align="center">
  ...
  --><a href="https://www.producthunt.com/products/new-api/launches/new-api?embed=true&utm_source=badge-featured&utm_medium=badge&utm_campaign=badge-new-api" target="_blank" rel="noopener noreferrer">
    <img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=1047693&theme=light&t=1769577875005" alt="API Plus - All-in-one AI asset management gateway. | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" />
  </a>
</p>
...
`api-plus` 不是早期 demo，而是已经长期演进的成熟多模型网关代码库。

从代码层看，当前已经明确具备：

- 多模型网关主干
- 用户与后台相关能力
- 充值 / 订阅支付相关代码（含 Stripe / 易支付入口）
- 渠道路由、重试、可用性探测、渠道亲和缓存相关实现
- 持续演进中的测试基线
...
1. 真实商业闭环是否已经按你的业务场景跑顺
2. 支付链路是否完成真实配置和验证
3. 路由 / 可用性 / 缓存能力是否已经稳定服务你的自有业务

### 配套记录

- 项目级变更日志：`CHANGELOG.md`
- 当前版本号：`VERSION`
...
| [new-api-horizon](https://github.com/Calcium-Ion/new-api-horizon) | API Plus 高性能优化版 |
