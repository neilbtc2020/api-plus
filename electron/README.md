# API Plus Electron Desktop App

This directory contains the Electron wrapper for API Plus, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
- **Production**:
  - macOS: `~/Library/Application Support/API Plus/data/`
  - Windows: `%APPDATA%/API Plus/data/`
  - Linux: `~/.config/API Plus/data/`
